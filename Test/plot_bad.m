...
f_in = f_s*(0:round(3000*nFFTin/f_s))/nFFTin;
f_out = f_s*(0:round(3000*nFFTout/f_s))/nFFTout;
...
%  
subplot(1,2,1)
plot(f_in,input_fft(1:round(3000*nFFTin/f_s+1)))
xlabel('Freq (Hz)')
ylabel('Amplitude')
...
subplot(1,2,2)
plot(f_out,output_fft(1:round(3000*nFFTout/f_s+1)))
xlabel('Freq (Hz)')
ylabel('Amplitude')
